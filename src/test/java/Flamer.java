    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for(int i = 0 ; i < alive_cnt ; i++) {
                ...
                if(opp_seen_cnt > 0 && my_score >= firePrice && my_flag_carrier != -1) str.append(String.format("FIRE %d 1", ids.get(i)));
//                if(my_score >= firePrice && my_flag_carrier != -1) str.append(String.format("FIRE %d 3", ids.get(i)));
