...
public abstract class UpgradeSkill implements Action {

//    int damage;
    int price;
    int upgradeCountLimit;
//    Coord origin;
    Minion upgradedUser;


    UpgradeSkill(Minion upgradedUser) {
//        this.origin = origin;
...
//    public abstract PowerUpType getPowerType();
    public abstract UpgradeSkillType getUpgradeType();
    public abstract boolean checkSkillLimit();
